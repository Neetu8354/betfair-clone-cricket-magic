...
const Contact = () => {
  ...
  const contactJsonLd = {
    ...
    "@type": "ContactPage",
    name: "Contact BetfairVIP Cricket Hub",
    url: "https://betfairvip.live/contact",
    description: "Get in touch with the BetfairVIP editorial team for cricket coverage, partnerships, corrections or community questions.",
    publisher: orgJsonLd,
  };
  ...
  return (
    <div className="min-h-screen bg-background pb-16 lg:pb-0">
      <Seo
        title="Contact BetfairVIP — Cricket Editorial, Partnerships & Support"
        description="Contact the BetfairVIP Cricket Hub team for editorial pitches, partnerships, corrections or community help. WhatsApp support available 7 days a week."
        canonical="/contact"
      ...
      <main className="container py-10">
        ...
        <header className="mx-auto max-w-3xl text-center">
          <h1 className="text-4xl font-extrabold tracking-tight md:text-5xl">Talk to the BetfairVIP team</h1>
        ...
        <section className="mx-auto mt-10 grid max-w-5xl gap-4 md:grid-cols-3">
          {[
            ...
            { icon: Mail, title: "Editorial desk", text: "Pitches, corrections and partnership enquiries.", href: "mailto:editors@betfairvip.live", cta: "editors@betfairvip.live" },
