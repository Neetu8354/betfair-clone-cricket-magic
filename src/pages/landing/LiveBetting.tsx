...
const FAQS = [
  { q: "What is live cricket prediction on Betfair?", a: "Live cricket prediction is the Betfair community feature where fans submit ball-by-ball and over-by-over forecasts during a match. It's free, social, and ranked on a public leaderboard." },
  { q: "How fast is the Betfair live scoreboard?", a: "Our live cricket scoreboard updates in roughly 0.8 seconds from the venue — faster than most TV broadcasts which run a 5–8 second delay." },
  { q: "Do I need any money to play live predictions?", a: "No. Betfair fan predictions are 100% free. We use virtual coins and a community leaderboard, never real-money wagering." },
...
const LiveBetting = () => (
  <div className="min-h-screen bg-background pb-16 lg:pb-0">
    <Seo
      title="Live Cricket Predictions — Real-Time Match Pulse | Betfair"
    ...
    <main className="container py-10">
      ...
      <section className="mx-auto mt-14 max-w-3xl space-y-4 text-base leading-relaxed text-muted-foreground">
        ...
        <p>
          Every Betfair live match gets a real-time scoreboard, a ball-by-ball pulse and a fan-prediction thread.
          The Betfair model rebuilds after each over — gaining roughly 12–15 points of accuracy versus its
        ...
        <h2 className="text-2xl font-bold text-foreground">What makes Betfair live mode different</h2>
      ...
      <section className="mx-auto mt-14 max-w-3xl rounded-2xl border border-border bg-card p-6">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h2 className="font-bold">Pro tip from the Betfair desk</h2>
